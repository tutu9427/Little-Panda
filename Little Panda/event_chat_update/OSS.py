...
bssDatabaseCRM = 'CRM/1jian8Shu!@10.10.201.19:1522/newdev'
ossDatabaseOD = 'OSSOD/smart123@10.10.196.67:1521/cc'

ossUrl = 'http://10.10.196.49:8000/oss/tmfapi/serviceOrder/v1/event/notification'
...
class OSS:
    ...
    def queryOssOrderDetail(self):
        queryOssOrderDetailSql="SELECT C.SPEC_NAME,A.ORD_NO,B.CFS_ID,A.CFS_EVENT_SPEC FROM OSSOD.OM_CFS_ORD A LEFT JOIN OSSOD.SRV_CFS_VER B ON A.ORD_NO =B.CREATE_ORD LEFT JOIN OSSOD.EPCS_SPEC C ON C.SPEC_ID=B.cfs_spec_id WHERE A.CUST_ORD_NO = '{}' ORDER BY C.SPEC_NAME DESC".format(self.ossOrderNo)
    ...
    def newConnection(self,bssOrderNo, ontModel="GN630V",ataModel="IAG400",ataPortNum="4",cpeDelivery="N",upbDelivery="N",dectPhoneDelivery='N'):
